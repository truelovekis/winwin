...
//    진로정보 좋아요
    public void careerInfoLikeRegister(CareerInfoLikeDto careerInfoLikeDto){
...
//    진로정보 글 좋아요 카운트
    public int careerInfoLikeCnt(Long careerInfoNumber){
...
//    유저가 좋아요 한 진로정보 글 찾기
    public CareerInfoLikeDto findCareerInfoUser(CareerInfoLikeDto careerInfoLikeDto){
        if (careerInfoLikeDto == null){
