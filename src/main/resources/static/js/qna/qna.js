    ...
    map.qnaList.forEach(qnaVoList => {
      ...
      <div class="qna-main-content">
        ...
        text += `
            ...
            <div class="user">
              <div class="qna-img">
                <div class="qna-cnt"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                ...
                <div class="qna-good">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up-fill hide" viewBox="0 0 16 16" style="color : #1b5192;">
