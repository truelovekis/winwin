...
function appendList(map) {
  ...
  map.activeCommentVoList.forEach(comment => {
    ...
    text += `
                  <a class="commu-move" href="${obj.url}=${comment.boardNumber}">
                <div class="reply-box">
                  <div class="commu-reply-top">
                    <span class="commu-tag">${obj.text}</span>
                  ...
                  <div class="commu-bottom">
                    ...
                    ${  comment.commentUp != -1 ?
                      `<div class="commu-good-box">
                        ...
                        <span class="commu-good">` + comment.commentUp + `</span>
                      </div>
                      <div class="commu-no-good-box">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="rgb(148, 155, 160)" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
